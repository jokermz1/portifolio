<?php $pageTitle = 'Create Account — ' . APP_NAME; ?>
            ...
            <div class="col-xl-9 col-lg-11 col-12">
                <div class="auth-card">
                    <div class="row g-0">
                        ...
                        <!-- ── Form panel ────────────────────── -->
                        <div class="col-md-7 auth-form-panel order-md-1 order-2">
                            <p class="letter-space text-muted mb-4" style="font-size:.68rem;">CREATE YOUR ACCOUNT</p>
                        ...
                        <!-- ── Brand panel ───────────────────── -->
                        <div class="col-md-5 auth-brand order-md-2 order-1">
                            <div class="auth-brand-inner">
                                ...
                                <h3 class="text-white mb-3" style="font-size:1.6rem; line-height:1.25; font-weight:700;">
                                    Join us<span class="text-primary">.</span>
                                </h3>
                                <p class="text-muted mb-0" style="font-size:.875rem; line-height:1.7;">
                                    Create your account and start leaving comments on my work.
                                </p>
                            </div>
