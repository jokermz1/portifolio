...
<div class="page-header">
    <div>
        <h1 class="page-title"><?= t('Novo Item') ?></h1>
        <span style="font-size:12px; color:var(--text-faint);"><?= t('Educação ou Experiência Profissional') ?></span>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>/admin/resume/create" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <!-- Título -->
                <div class="col-12">
                    <label class="form-label" id="title-label"><?= t('Grau / Título') ?> *</label>
                ...
                <!-- Subtítulo -->
                <div class="col-md-8">
                    <label class="form-label" id="subtitle-label"><?= t('Instituição') ?></label>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" class="form-control" rows="4"
                        placeholder="<?= e_t('Descreva o percurso, responsabilidades ou conquistas...') ?>"></textarea>
                    <small style="color:var(--text-faint); font-size:11px;">
                        <?= t('Pode usar nova linha para separar parágrafos ou criar uma lista com "- item".') ?>
                    </small>
                </div>
                ...
                <div class="col-12">
                    ...
                    <small style="color:var(--text-faint); font-size:11px;">
                        <?= t('Opcional. PDF, imagem ou documento Word. Máx. 15 MB. Exemplo: diploma, certificado, carta de recomendação.') ?>
                    </small>
                </div>

                <div class="col-12">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i><?= t('Criar Item') ?>
                    </button>
                </div>
