            ...
            <div class="row justify-content-center text-center">
                <div class="col-xl-8">
                    ...
                    <h2 class="banner-size display-1" data-aos="fade-up" data-aos-duration="1200">
                        Contact Us<span class="text-primary">.</span>
                    </h2>
            ...
            <section id="contact-form" class="padding-medium">
                <div class="container" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div class="row g-5">
                        ...
                        <!-- Form -->
                        <div class="col-lg-7">
                            <h3 class="display-3 mb-2">Got any questions?<span class="text-primary">.</span></h3>
                            <p class="text-muted mb-5">Use the form below to get in touch with us.</p>
                        ...
                        <div class="col-lg-5" data-aos="fade-up" data-aos-duration="1800">
                            <h3 class="display-3 mb-2">Contact information<span class="text-primary">.</span></h3>
                            <p class="text-muted mb-5">Feel free to reach out through any of the channels below.</p>

                            <!-- Head Office -->
                            <div class="mb-5">
                                <h5 class="text-primary fw-semibold mb-3 letter-space">Head Office</h5>
                            ...
                            <!-- Social -->
                            <div>
                                <h5 class="text-primary fw-semibold mb-3 letter-space">Social info</h5>
